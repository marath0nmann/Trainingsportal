<?php
// Stub: lädt zentrale totp-Klasse aus dem Statistikportal-Schwesterordner.
// Standard-Pfad: ../../statistik.tus-oedt.de/includes/totp.php (all-inkl-Subdomain-Layout).
