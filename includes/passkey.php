<?php
// Stub: lädt zentrale passkey-Klasse aus dem Statistikportal-Schwesterordner.
// Standard-Pfad: ../../statistik.tus-oedt.de/includes/passkey.php (all-inkl-Subdomain-Layout).
