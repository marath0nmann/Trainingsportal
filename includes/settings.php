<?php
// Stub: lädt zentrale settings-Klasse aus dem Statistikportal-Schwesterordner.
// Standard-Pfad: ../../statistik.tus-oedt.de/includes/settings.php (all-inkl-Subdomain-Layout).
...
require_once $_inc . '/settings.php';
